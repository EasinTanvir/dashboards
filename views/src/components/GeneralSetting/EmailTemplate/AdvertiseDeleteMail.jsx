...
const AdvertiseDeleteMail = () => {
  ...
  const defaultTemplate = `
    ...
    <br />
    <p>Your advertisement delete mail has sent successfully</p>
...
export default AdvertiseDeleteMail;
